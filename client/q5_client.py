...
r_prop = args[1]
a_prop = args[2]
str = 'curl -i http://geoprovdb.webfactional.com/api/v2.0/provenance/%(direction)s/resource/%(rprop)s/activity/%(aprop)s' % {"direction":direction,"rprop":r_prop,"aprop":a_prop}
print str
os.system(str)
